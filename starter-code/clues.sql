...
-- world=# SELECT name, population FROM countries WHERE region='Southern Europe' ORDER BY population ASC;
...
-- alt solution: SELECT * FROM countrylanguages WHERE language='Italian' ORDER BY percentage DESC LIMIT 1;
-- San Marino
...
-- Common Commands: 
-- \d cities => shows all data of 'cities' table
-- SELECT * FROM cities => 'Show all columns from cities table'
-- JOIN countries ON cities.countrycode = countries.code => ''
-- SELECT cities.name, cities.countrycode, countries.name, countries.code FROM cities 
-- join tables are used in many to many relationships. 
